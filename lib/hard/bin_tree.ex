defmodule Exercism.BinTree do
  ...
  @type t :: %Exercism.BinTree{value: any, left: t() | nil, right: t() | nil}

  defstruct [:value, :left, :right]
end

defimpl Inspect, for: Exercism.BinTree do
  ...
  def inspect(%Exercism.BinTree{value: value, left: left, right: right}, opts) do
    concat([
      "(",
      to_doc(value, opts),
      ":",
