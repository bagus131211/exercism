defmodule Exercism.TakeANumberDeluxe.State do
  defstruct min_number: 1, max_number: 999, queue: nil, auto_shutdown_timeout: :infinity
  @type t :: %__MODULE__{}

  alias Exercism.TakeANumberDeluxe.Queue

  @spec new(integer, integer, timeout) :: {:ok, Exercism.TakeANumberDeluxe.State.t()} | {:error, atom()}
  ...
  @spec queue_new_number(Exercism.TakeANumberDeluxe.State.t()) ::
          {:ok, integer(), Exercism.TakeANumberDeluxe.State.t()} | {:error, atom()}
  ...
  @spec serve_next_queued_number(Exercism.TakeANumberDeluxe.State.t(), integer() | nil) ::
          {:ok, integer(), Exercism.TakeANumberDeluxe.State.t()} | {:error, atom()}
