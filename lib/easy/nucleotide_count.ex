defmodule Exercism.NucleotideCount do
  @moduledoc """
  ...
  def histogram(strand), do: strand |> Enum.reduce(@nucleotides |> Map.new(& {&1,0}), &update/2)

  defp update(char, map), do: Map.update!(map, char, &(&1 + 1))
end
