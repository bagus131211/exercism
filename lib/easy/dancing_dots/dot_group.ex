defmodule Exercism.DancingDots.DotGroup do
  ...
  """
  @spec new([Exercism.DancingDots.Dot.t()]) :: t()
  def new(dots) do
    %__MODULE__{
      dots: dots,
  ...
  """
  @spec add_animation(t(), module, Exercism.DancingDots.Animation.opts()) ::
          {:ok, t()} | {:error, Exercism.DancingDots.Animation.error()}
  ...
  """
  @spec render_dots(t(), Exercism.DancingDots.Animation.frame_number()) :: [Exercism.DancingDots.Dot.t()]
